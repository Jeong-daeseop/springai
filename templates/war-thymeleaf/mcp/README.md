...
## 1. egov-war-web 적용 위치

| 파일 | 복사 위치 |
|---|---|
| `layout/*.html` | `src/main/resources/templates/layout/` |
| `styles.css`, `_ds_bundle.css` | `src/main/webapp/resources/css/` |
| `krds.min.js` | `src/main/webapp/resources/js/` |
...
- 화면 링크 URL은 `/resources/**`를 사용한다.
- WAR 프로젝트의 실제 파일 저장 위치는 `src/main/webapp/resources/**`다.
