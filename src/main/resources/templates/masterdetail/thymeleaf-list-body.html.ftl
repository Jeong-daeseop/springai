    <div class="egov-page-header">
        ...
        <div class="egov-button-group">
            <button id="btnBulkDelete" type="button" class="krds-btn negative medium egov-btn egov-hidden"
                    onclick="openBulkDeleteModal()">선택삭제</button>
            <a th:href="@{${urlPrefix}RegistView.do}" class="krds-btn primary medium egov-btn">
    ...
    <div class="egov-search-panel">
        <form id="searchForm" class="egov-search-form" th:action="@{${urlPrefix}List.do}" method="get">
            ...
            <div class="egov-search-row">
                ...
                <a th:href="@{${urlPrefix}List.do}" class="krds-btn secondary medium egov-btn egov-inline-action">
...
<#else>
                ...
                <td class="egov-table-actions">
                    ...
                    <button type="button" class="krds-btn negative small egov-btn"
    ...
    <form id="bulkDeleteForm" th:action="@{${urlPrefix}BulkDelete.do}" method="post" class="egov-hidden">
        <input th:if="${'$'}{_csrf != null}" type="hidden"
               th:name="${'$'}{_csrf.parameterName}" th:value="${'$'}{_csrf.token}"/>
    </form>
