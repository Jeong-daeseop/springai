...
FROM   LETTNROLEINFO ri
JOIN   LETTNAUTHORROLERELATE ar ON ri.ROLE_CODE = ar.ROLE_CODE
...
-- [2] ROLE 계층 조회 (LETTNROLES_HIERARCHY)
...
-- LETTNROLEINFO INSERT → LETTNAUTHORROLERELATE INSERT
...
FROM   LETTNMENUINFO m
JOIN   LETTNPROGRMLIST p ON m.PROGRM_FILE_NM = p.PROGRM_FILE_NM
ORDER  BY m.MENU_NO;
